local high_visibility = require "asciiville.util.config".settings.high_visibility
...
if vim.g.asciiville_style == "darker" then
    -- Darker theme style
...
elseif vim.g.asciiville_style == "lighter" then
    -- Lighter theme style
...
elseif vim.g.asciiville_style == "palenight" then
...
elseif vim.g.asciiville_style == "deep ocean" then
...
else vim.g.asciiville_style = "oceanic"
    -- Oceanic theme style
